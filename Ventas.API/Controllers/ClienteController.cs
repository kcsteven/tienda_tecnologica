...
namespace Ventas.API.Controllers
{
    ...
    public class ClienteController : ControllerBase
    {
        ...
        {
            var resultado = await _clienteLN.ObtenerAsync(
            new TCliente
            {
                ClienteId = id
            });
        ...
        [HttpGet("Buscar")]
        [ResponseCache(NoStore = true, Location = ResponseCacheLocation.None)]
        public async Task<IActionResult> Buscar(string nombreCliente)
        {
            var resultado = await _clienteLN.BuscarAsync(
            new TCliente
            {
        ...
        {
            var resultado = await _clienteLN.EliminarAsync(
            new TCliente
            {
                ClienteId = id
            });
