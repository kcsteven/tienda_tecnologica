...
export class TiendaProductoListadoComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.data.subscribe(data => {
      const esSubcategoria = data['tipo'] === 'subcategoria';
  ...
  /** Ruta /categoria/:id — muestra productos de TODAS las subcategorías de esa categoría */
  ...
  /** Ruta /subcategoria/:id — muestra productos de una subcategoría puntual (ej. "Laptop") */
